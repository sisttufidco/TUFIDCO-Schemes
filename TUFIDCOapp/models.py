...
class MasterSanctionForm(models.Model):
    ...
    ProjectCost = models.DecimalField("Project Cost", decimal_places=3, blank=True, max_digits=10, null=True)
    ProposedCostByULB = models.DecimalField("Proposed Cost by ULB", decimal_places=3, blank=True, max_digits=10,
                                            null=True)
    ApprovedProjectCost = models.DecimalField("Approved Project Cost", blank=True, decimal_places=3, max_digits=10,
                                              null=True)
    SchemeShare = models.DecimalField("Scheme Share", decimal_places=3, blank=True, max_digits=10, null=True)
    ULBShare = models.DecimalField("ULB Share", decimal_places=3, blank=True, max_digits=10, null=True)
    ...
    total = models.DecimalField("Total", decimal_places=3, blank=True, max_digits=10, null=True)
