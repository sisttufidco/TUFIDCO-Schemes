...
@admin.register(KNMTDashboardR2223)
class DashboardAdmin(admin.ModelAdmin):
    change_list_template = "admin/dashboard.html"
    ...
    def changelist_view(self, request, extra_context=None):
        ...
        total_projects = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).count()
        project_cost = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).aggregate(project_cost=Sum('ApprovedProjectCost'))
        dmp_project_cost = MasterSanctionForm.objects.filter(AgencyType__AgencyType='Municipality').filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).aggregate(dmp_project_cost=Sum('ApprovedProjectCost'))
        ctp_project_cost = MasterSanctionForm.objects.filter(AgencyType__AgencyType='Town Panchayat').filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).aggregate(ctp_project_cost=Sum('ApprovedProjectCost'))
        if ctp_project_cost['ctp_project_cost'] == None:
            ctp_project_cost['ctp_project_cost'] = 0
        
        sector_list = list(MasterSanctionForm.objects.values_list('Sector', flat=True).all().distinct().filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).exclude(Sector__in=['BT Road', 'CC Road', 'Retaining wall', 'Paver Block', 'SWD', 'Culvert',
                        'Metal Beam Crash Barriers']))
        swps_final_list = []
        
        for sector in sector_list:
            sector_total = MasterSanctionForm.objects.filter(Sector=sector).filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(Scheme__Scheme='KNMT').count()
            sector_cost = MasterSanctionForm.objects.filter(Sector=sector).filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(Scheme__Scheme='KNMT').aggregate(project_cost=Sum('ApprovedProjectCost'))
            try:
                sector_percentage = "{:.2f}".format((sector_cost['project_cost']) / (project_cost['project_cost']) * 100)
            except TypeError:
                sector_percentage = 0.0
            DMA_total = MasterSanctionForm.objects.filter(Sector=sector).filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(AgencyType__AgencyType="Municipality").count()
            DMA_cost = MasterSanctionForm.objects.filter(Sector=sector).filter(Scheme__Scheme='KNMT').filter(AgencyType__AgencyType="Municipality").filter(Date_AS__range=["2022-04-01", "2023-03-31"]).aggregate(project_cost=Sum('ApprovedProjectCost'))
            try:
                DMA_percentage = "{:.2f}".format((DMA_cost['project_cost']) / (dmp_project_cost['dmp_project_cost']) * 100)
            except TypeError:
                DMA_percentage = 0.0
            CTP_total = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Sector=sector).filter(AgencyType__AgencyType="Town Panchayat").filter(Date_AS__range=["2022-04-01", "2023-03-31"]).count()
            CTP_cost = MasterSanctionForm.objects.filter(Sector=sector).filter(Scheme__Scheme='KNMT').filter(AgencyType__AgencyType="Town Panchayat").filter(Date_AS__range=["2022-04-01", "2023-03-31"]).aggregate(project_cost=Sum('ApprovedProjectCost'))
            try:
                CTP_percentage = "{:.2f}".format((CTP_cost['project_cost']) / (ctp_project_cost['ctp_project_cost']) * 100)
            except TypeError:
                CTP_percentage = 0.0
        ...
        if roadCTP['project_cost'] == None:
            roadCTP['project_cost'] = 0

        roadCTP_total = MasterSanctionForm.objects.filter(Sector__in=['BT Road', 'CC Road', 'Retaining wall', 'Paver Block', 'SWD', 'Culvert', 'Metal Beam Crash Barriers']).filter(AgencyType__AgencyType="Town Panchayat").filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).count()
        CTProad_percentage = "{:.2f}".format((roadCTP['project_cost']) / (ctp_project_cost['ctp_project_cost']) * 100)
        dic2 = {
            "sector_total":road_total,
            "sector_cost":road,
        ...
        sector_progress = []
        sector_progress_list = list(MasterSanctionForm.objects.values_list('Sector', flat=True).order_by('Sector').all().distinct().filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]))
        ...
        for sector in sector_progress_list:
            approved_project_count = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Sector=sector).filter(Date_AS__range=["2022-04-01", "2023-03-31"]).count()
            approved_project_cost = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Sector=sector).filter(Date_AS__range=["2022-04-01", "2023-03-31"]).aggregate(project_cost=Sum('ApprovedProjectCost'))
            completed_count = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(Sector=sector).filter(status='Completed').count()
            completed_approved_project_cost = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(Sector=sector).filter(status='Completed').aggregate(project_cost=Sum('ApprovedProjectCost'))
            inprogress_count = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(Sector=sector).filter(status='In Progress').count()
            inprogress_approved_project_cost = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(Sector=sector).filter(status='In Progress').aggregate(project_cost=Sum('ApprovedProjectCost'))
            tobecommenced_count = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Sector=sector).filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(~Q(Project_ID__in=final_list)).count()
            tobecommenced_project_cost = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Sector=sector).filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(~Q(Project_ID__in=final_list)).aggregate(project_cost=Sum('ApprovedProjectCost'))
            awarded_cost = AgencySanctionModel.objects.filter(Scheme='KNMT').filter(Sector=sector).aggregate(project_cost=Sum('work_awarded_amount1'))
            modal_data = list(MasterSanctionForm.objects.values('AgencyName__AgencyName', 'Project_ID').order_by('AgencyName__AgencyName').filter(Scheme__Scheme='KNMT').filter(Sector=sector).filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(~Q(Project_ID__in=final_list)))
            in_progress = list(AgencyProgressModel.objects.values('ULBName', 'Project_ID', 'percentageofworkdone').order_by('ULBName').filter(Scheme='KNMT').filter(Sector=sector).filter(status='In Progress').annotate(percent=Avg('percentageofworkdone')))
        ...
        DMAsector_progress = []
        DMAsector_progress_list = list(MasterSanctionForm.objects.values_list('Sector', flat=True).order_by('Sector').all().distinct().filter(Scheme__Scheme='KNMT').filter(AgencyType__AgencyType="Municipality").filter(Date_AS__range=["2022-04-01", "2023-03-31"]))
        
        for sector in DMAsector_progress_list:
            approved_project_count = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(AgencyType__AgencyType="Municipality").filter(Sector=sector).filter(Date_AS__range=["2022-04-01", "2023-03-31"]).count()
            approved_project_cost = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(AgencyType__AgencyType="Municipality").filter(Sector=sector).filter(Date_AS__range=["2022-04-01", "2023-03-31"]).aggregate(project_cost=Sum('ApprovedProjectCost'))
            completed_count = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(Sector=sector).filter(ULBType="Municipality").filter(status='Completed').count()
            completed_approved_project_cost = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(ULBType="Municipality").filter(Sector=sector).filter(status='Completed').aggregate(project_cost=Sum('ApprovedProjectCost'))
            inprogress_count = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(ULBType="Municipality").filter(Sector=sector).filter(status='In Progress').count()
            inprogress_approved_project_cost = AgencyProgressModel.objects.filter(ULBType="Municipality").filter(Scheme='KNMT').filter(Sector=sector).filter(status='In Progress').aggregate(project_cost=Sum('ApprovedProjectCost'))
            tobecommenced_count = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(AgencyType__AgencyType="Municipality").filter(Sector=sector).filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(~Q(Project_ID__in=final_list)).count()
            tobecommenced_project_cost = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(AgencyType__AgencyType="Municipality").filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(Sector=sector).filter(~Q(Project_ID__in=final_list)).aggregate(project_cost=Sum('ApprovedProjectCost'))
            awarded_cost = AgencySanctionModel.objects.filter(Scheme='KNMT').filter(Sector=sector).filter(ULBType="Municipality").aggregate(project_cost=Sum('work_awarded_amount1'))
            modal_data = list(MasterSanctionForm.objects.values('AgencyName__AgencyName', 'Project_ID').order_by('AgencyName__AgencyName').filter(AgencyType__AgencyType="Municipality").filter(Scheme__Scheme='KNMT').filter(Sector=sector).filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(~Q(Project_ID__in=final_list)))
            in_progress = list(AgencyProgressModel.objects.values('ULBName', 'Project_ID', 'percentageofworkdone').order_by('ULBName').filter(ULBType="Municipality").filter(Scheme='KNMT').filter(Sector=sector).filter(status='In Progress').annotate(percent=Avg('percentageofworkdone')))
        ...
        CTPsector_progress = []
        CTPsector_progress_list = list(MasterSanctionForm.objects.values_list('Sector', flat=True).order_by('Sector').all().distinct().filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(AgencyType__AgencyType="Town Panchayat"))
        
        for sector in CTPsector_progress_list:
            approved_project_count = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(AgencyType__AgencyType="Town Panchayat").filter(Sector=sector).filter(Date_AS__range=["2022-04-01", "2023-03-31"]).count()
            approved_project_cost = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(AgencyType__AgencyType="Town Panchayat").filter(Sector=sector).filter(Date_AS__range=["2022-04-01", "2023-03-31"]).aggregate(project_cost=Sum('ApprovedProjectCost'))
            completed_count = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(Sector=sector).filter(ULBType="Town Panchayat").filter(status='Completed').count()
            completed_approved_project_cost = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(ULBType="Town Panchayat").filter(Sector=sector).filter(status='Completed').aggregate(project_cost=Sum('ApprovedProjectCost'))
            inprogress_count = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(ULBType="Town Panchayat").filter(Sector=sector).filter(status='In Progress').count()
            inprogress_approved_project_cost = AgencyProgressModel.objects.filter(ULBType="Town Panchayat").filter(Scheme='KNMT').filter(Sector=sector).filter(status='In Progress').aggregate(project_cost=Sum('ApprovedProjectCost'))
            tobecommenced_count = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(AgencyType__AgencyType="Town Panchayat").filter(Sector=sector).filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(~Q(Project_ID__in=final_list)).count()
            tobecommenced_project_cost = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(AgencyType__AgencyType="Town Panchayat").filter(Sector=sector).filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(~Q(Project_ID__in=final_list)).aggregate(project_cost=Sum('ApprovedProjectCost'))
            awarded_cost = AgencySanctionModel.objects.filter(Scheme='KNMT').filter(Sector=sector).filter(ULBType="Town Panchayat").aggregate(project_cost=Sum('work_awarded_amount1'))
            modal_data = list(MasterSanctionForm.objects.values('AgencyName__AgencyName', 'Project_ID').order_by('AgencyName__AgencyName').filter(AgencyType__AgencyType="Town Panchayat").filter(Scheme__Scheme='KNMT').filter(Sector=sector).filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(~Q(Project_ID__in=final_list)))
            in_progress = list(AgencyProgressModel.objects.values('ULBName', 'Project_ID', 'percentageofworkdone').order_by('ULBName').filter(ULBType="Town Panchayat").filter(Scheme='KNMT').filter(Sector=sector).filter(status='In Progress').annotate(percent=Avg('percentageofworkdone')))
        ...
        district_map = []
        for district in district_list:
            District_project_cost = MasterSanctionForm.objects.filter(District__District=district).filter(Date_AS__range=["2022-04-01", "2023-03-31"]).aggregate(project_cost=Sum('ApprovedProjectCost'))
            District_total_projects = MasterSanctionForm.objects.filter(District__District=district).filter(Date_AS__range=["2022-04-01", "2023-03-31"]).count()
            DMA_project_cost = MasterSanctionForm.objects.filter(District__District=district).filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(AgencyType__AgencyType='Municipality').aggregate(project_cost=Sum('ApprovedProjectCost'))
            DMA_total_projects = MasterSanctionForm.objects.filter(District__District=district).filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(AgencyType__AgencyType='Municipality').count()
            CTP_project_cost = MasterSanctionForm.objects.filter(District__District=district).filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(AgencyType__AgencyType='Town Panchayat').aggregate(project_cost=Sum('ApprovedProjectCost'))
            CTP_total_projects = MasterSanctionForm.objects.filter(District__District=district).filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(AgencyType__AgencyType='Town Panchayat').count()
            Latitude = list(District.objects.values_list('Latitude', flat=True).filter(District=district))[0]
            Longitude = list(District.objects.values_list('Longitude', flat=True).filter(District=district))[0]
        ...
        total_awarded_cost = AgencySanctionModel.objects.filter(Scheme='KNMT').aggregate(
            project_cost=Sum('work_awarded_amount1'))
        total_ap_project_count = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).count()
        total_approved_project_cost = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).aggregate(
            project_cost=Sum('ApprovedProjectCost'))
        total_completed_count = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(
            status='Completed').count()
        total_completed_approved_project_cost = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(
        ...
        total_inprogress_approved_project_cost = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(
            status='In Progress').aggregate(project_cost=Sum('ApprovedProjectCost'))
        total_tobecommenced_count = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(
            ~Q(Project_ID__in=final_list)).count()
        total_tobecommenced_project_cost = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(
            ~Q(Project_ID__in=final_list)).aggregate(project_cost=Sum('ApprovedProjectCost'))

        DMAtotal_awarded_cost = AgencySanctionModel.objects.filter(Scheme='KNMT').filter(
            ULBType='Municipality').aggregate(
            project_cost=Sum('work_awarded_amount1'))
        DMAtotal_approved_project_count = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(
            AgencyType__AgencyType='Municipality').count()
        DMAtotal_approved_project_cost = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(
            AgencyType__AgencyType='Municipality').aggregate(
            project_cost=Sum('ApprovedProjectCost'))
        DMAtotal_completed_count = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(
            ULBType='Municipality').filter(
        ...
        DMAtotal_inprogress_approved_project_cost = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(
            ULBType='Municipality').filter(
            status='In Progress').aggregate(project_cost=Sum('ApprovedProjectCost'))
        DMAtotal_tobecommenced_count = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(
            AgencyType__AgencyType='Municipality').filter(
            ~Q(Project_ID__in=final_list)).count()
        DMAtotal_tobecommenced_project_cost = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(
            AgencyType__AgencyType='Municipality').filter(
            ~Q(Project_ID__in=final_list)).aggregate(project_cost=Sum('ApprovedProjectCost'))
        ...
        CTPtotal_awarded_cost = AgencySanctionModel.objects.filter(Scheme='KNMT').filter(
            ULBType='Town Panchayat').aggregate(
            project_cost=Sum('work_awarded_amount1'))
        CTPtotal_approved_project_count = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(
            AgencyType__AgencyType='Town Panchayat').count()
        CTPtotal_approved_project_cost = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(
            AgencyType__AgencyType='Town Panchayat').aggregate(
            project_cost=Sum('ApprovedProjectCost'))
        CTPtotal_completed_count = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(
            ULBType='Town Panchayat').filter(
        ...
        CTPtotal_inprogress_approved_project_cost = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(
            ULBType='Town Panchayat').filter(
            status='In Progress').aggregate(project_cost=Sum('ApprovedProjectCost'))
        CTPtotal_tobecommenced_count = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(
            AgencyType__AgencyType='Town Panchayat').filter(
            ~Q(Project_ID__in=final_list)).count()
        CTPtotal_tobecommenced_project_cost = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(
            AgencyType__AgencyType='Town Panchayat').filter(
            ~Q(Project_ID__in=final_list)).aggregate(project_cost=Sum('ApprovedProjectCost'))        

        busstand = MasterSanctionForm.objects.filter(Sector__in=['Bus Stand']).filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).aggregate(
            project_cost=Sum('ApprovedProjectCost'))
        busstand_total = MasterSanctionForm.objects.filter(Sector__in=['Bus Stand']).filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(
            Scheme__Scheme='KNMT').count()
        busstandDMA = MasterSanctionForm.objects.filter(Sector__in=['Bus Stand']).filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(
            AgencyType__AgencyType="Municipality").aggregate(project_cost=Sum('ApprovedProjectCost'))
        busstandDMA_total = MasterSanctionForm.objects.filter(Sector__in=['Bus Stand']).filter(
            Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(
            AgencyType__AgencyType="Municipality").count()
        busstandCTP = MasterSanctionForm.objects.filter(Sector__in=['Bus Stand']).filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(
            AgencyType__AgencyType="Town Panchayat").aggregate(project_cost=Sum('ApprovedProjectCost'))
        busstandCTP_total = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(
            Sector__in=['Bus Stand']).filter(
            AgencyType__AgencyType="Town Panchayat").count()

        ch = MasterSanctionForm.objects.filter(Sector__in=['Community Hall']).filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).aggregate(
            project_cost=Sum('ApprovedProjectCost'))
        ch_total = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(
            Sector__in=['Community Hall']).count()
        chDMA = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(Sector__in=['Community Hall']).filter(
            AgencyType__AgencyType="Municipality").aggregate(project_cost=Sum('ApprovedProjectCost'))
        chDMA_total = MasterSanctionForm.objects.filter(Sector__in=['Community Hall']).filter(
            Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(
            AgencyType__AgencyType="Municipality").count()
        chCTP = MasterSanctionForm.objects.filter(Sector="Community Hall").filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(
            AgencyType__AgencyType="Town Panchayat").aggregate(project_cost=Sum('ApprovedProjectCost'))
        chCTP_total = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(
            Sector__in=['Community Hall']).filter(
            AgencyType__AgencyType="Town Panchayat").count()

        crematorium = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(
            Sector__in=['Crematorium']).aggregate(
            project_cost=Sum('ApprovedProjectCost'))
        crematorium_total = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(
            Sector__in=['Crematorium']).count()
        crematoriumDMA = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(
            Sector__in=['Crematorium']).filter(
            AgencyType__AgencyType="Municipality").filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).aggregate(
            project_cost=Sum('ApprovedProjectCost'))
        crematoriumDMA_total = MasterSanctionForm.objects.filter(Sector__in=['Crematorium']).filter(
            Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(
            AgencyType__AgencyType="Municipality").count()
        crematoriumCTP = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(
            Sector__in=['Crematorium']).filter(
            AgencyType__AgencyType="Town Panchayat").aggregate(project_cost=Sum('ApprovedProjectCost'))
        crematoriumCTP_total = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(
            Sector__in=['Crematorium']).filter(
            AgencyType__AgencyType="Town Panchayat").count()

        KC = MasterSanctionForm.objects.filter(Sector__in=['Knowledge Centre']).filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).aggregate(
            project_cost=Sum('ApprovedProjectCost'))
        KC_total = MasterSanctionForm.objects.filter(Sector__in=['Knowledge Centre']).filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(
            Scheme__Scheme='KNMT').count()
        KCDMA = MasterSanctionForm.objects.filter(Sector__in=['Knowledge Centre']).filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(
            AgencyType__AgencyType="Municipality").aggregate(project_cost=Sum('ApprovedProjectCost'))
        KCDMA_total = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(
            Sector__in=['Knowledge Centre']).filter(
            AgencyType__AgencyType="Municipality").count()
        KCCTP = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(Sector__in=['Knowledge Centre']).filter(
            AgencyType__AgencyType="Town Panchayat").aggregate(project_cost=Sum('ApprovedProjectCost'))
        KCCTP_total = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(
            Sector__in=['Knowledge Centre']).filter(
            AgencyType__AgencyType="Town Panchayat").count()

        market = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(Sector__in=['Market']).aggregate(
            project_cost=Sum('ApprovedProjectCost'))
        market_total = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(Sector__in=['Market']).count()
        marketDMA = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(Sector__in=['Market']).filter(
            AgencyType__AgencyType="Municipality").aggregate(project_cost=Sum('ApprovedProjectCost'))
        marketDMA_total = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(Sector__in=['Market']).filter(
            AgencyType__AgencyType="Municipality").count()
        marketCTP = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(Sector__in=['Market']).filter(
            AgencyType__AgencyType="Town Panchayat").aggregate(project_cost=Sum('ApprovedProjectCost'))
        marketCTP_total = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(Sector__in=['Market']).filter(
            AgencyType__AgencyType="Town Panchayat").count()
        
        park = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Sector__in=['Parks']).filter(Date_AS__range=["2022-04-01", "2023-03-31"]).aggregate(
            project_cost=Sum('ApprovedProjectCost'))
        park_total = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Sector__in=['Parks']).filter(Date_AS__range=["2022-04-01", "2023-03-31"]).count()
        parkDMA = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Sector__in=['Parks']).filter(
            AgencyType__AgencyType="Municipality").filter(Date_AS__range=["2022-04-01", "2023-03-31"]).aggregate(project_cost=Sum('ApprovedProjectCost'))
        parkDMA_total = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Sector__in=['Parks']).filter(
            AgencyType__AgencyType="Municipality").filter(Date_AS__range=["2022-04-01", "2023-03-31"]).count()
        parkCTP = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Sector__in=['Parks']).filter(
            AgencyType__AgencyType="Town Panchayat").filter(Date_AS__range=["2022-04-01", "2023-03-31"]).aggregate(project_cost=Sum('ApprovedProjectCost'))
        
        if parkCTP['project_cost'] == None:
            parkCTP['project_cost'] = 0
        
        parkCTP_total = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Sector__in=['Parks']).filter(
            AgencyType__AgencyType="Town Panchayat").filter(Date_AS__range=["2022-04-01", "2023-03-31"]).count()

        SWM = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(
            Sector__in=['Solid Waste Mgt.']).aggregate(
            project_cost=Sum('ApprovedProjectCost'))
        SWM_total = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(
            Sector__in=['Solid Waste Mgt.']).count()
        SWMDMA = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(
            Sector__in=['Solid Waste Mgt.']).filter(
            AgencyType__AgencyType="Municipality").aggregate(project_cost=Sum('ApprovedProjectCost'))
        SWMDMA_total = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(
            Sector__in=['Solid Waste Mgt.']).filter(
            AgencyType__AgencyType="Municipality").count()
        SWMCTP = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(
            Sector__in=['Solid Waste Mgt.']).filter(
            AgencyType__AgencyType="Town Panchayat").aggregate(project_cost=Sum('ApprovedProjectCost'))
        SWMCTP_total = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(
            Sector__in=['Solid Waste Mgt.']).filter(
            AgencyType__AgencyType="Town Panchayat").count()

        RW = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(Sector__in=['Retaining wall']).aggregate(
            project_cost=Sum('ApprovedProjectCost'))
        RW_total = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(
            Sector__in=['Retaining wall']).count()
        RWDMA = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Sector__in=['Retaining wall']).filter(
            AgencyType__AgencyType="Municipality").filter(Date_AS__range=["2022-04-01", "2023-03-31"]).aggregate(project_cost=Sum('ApprovedProjectCost'))
        RWDMA_total = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(
            Sector__in=['Retaining wall']).filter(AgencyType__AgencyType="Municipality").filter(Date_AS__range=["2022-04-01", "2023-03-31"]).count()
        RWCTP = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Sector="Retaining wall").filter(
            AgencyType__AgencyType="Town Panchayat").filter(Date_AS__range=["2022-04-01", "2023-03-31"]).aggregate(project_cost=Sum('ApprovedProjectCost'))
        RWCTP_total = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(
            Sector__in=['Retaining wall']).filter(
        ...
        WB = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Sector__in=['Water Bodies']).filter(Date_AS__range=["2022-04-01", "2023-03-31"]).aggregate(
            project_cost=Sum('ApprovedProjectCost'))
        WB_total = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Sector__in=['Water Bodies']).filter(Date_AS__range=["2022-04-01", "2023-03-31"]).count()
        WBDMA = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Sector__in=['Water Bodies']).filter(Date_AS__range=["2022-04-01", "2023-03-31"]).filter(
            AgencyType__AgencyType="Municipality").filter(Date_AS__range=["2022-04-01", "2023-03-31"]).aggregate(project_cost=Sum('ApprovedProjectCost'))
        WBDMA_total = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(
            Sector__in=['Water Bodies']).filter(AgencyType__AgencyType="Municipality").filter(Date_AS__range=["2022-04-01", "2023-03-31"]).count()
        WBCTP = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Sector="Water Bodies").filter(
            AgencyType__AgencyType="Town Panchayat").filter(Date_AS__range=["2022-04-01", "2023-03-31"]).aggregate(project_cost=Sum('ApprovedProjectCost'))
        WBCTP_total = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(
            Sector__in=['Water Bodies']).filter(AgencyType__AgencyType="Town Panchayat").filter(Date_AS__range=["2022-04-01", "2023-03-31"]).count()
        
        if project_cost['project_cost'] == None:
           project_cost['project_cost'] = 0        
                
        if ch['project_cost'] == None:
            ch['project_cost'] = 0
        
        if SWM['project_cost'] == None:
            SWM['project_cost'] = 0

        if RW['project_cost'] == None:
            RW['project_cost'] = 0
        ...
        if marketDMA['project_cost'] == None:
            marketDMA['project_cost'] = 0
        ...
        if RWCTP['project_cost'] == None:
            RWCTP['project_cost'] = 0
        
        if chCTP['project_cost'] == None:
            chCTP['project_cost'] = 0

        if KCCTP['project_cost'] == None:
            KCCTP['project_cost'] = 0
        
        if SWMCTP['project_cost'] == None:
            SWMCTP['project_cost'] = 0
        ...
        knmt = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).aggregate(knmt_share=Sum('SchemeShare'))
        ulb_share = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).aggregate(ulb_share=Sum('ULBShare'))
        dmp_total_projects = MasterSanctionForm.objects.filter(AgencyType__AgencyType='Municipality').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).count()
        dmp_knmt = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(
            AgencyType__AgencyType='Municipality').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).aggregate(dmp_knmt=Sum('SchemeShare'))
        dmp_ulb_share = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(
            AgencyType__AgencyType='Municipality').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).aggregate(dmp_ulb_share=Sum('ULBShare'))
        ctp_total_projects = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(
            AgencyType__AgencyType='Town Panchayat').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).count()
        ctp_project_cost = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(
            AgencyType__AgencyType='Town Panchayat').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).aggregate(ctp_project_cost=Sum('ApprovedProjectCost'))
        ctp_knmt = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(
            AgencyType__AgencyType='Town Panchayat').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).aggregate(ctp_knmt=Sum('SchemeShare'))
        ctp_ulb_share = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(
            AgencyType__AgencyType='Town Panchayat').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).aggregate(ctp_ulb_share=Sum('ULBShare'))
        if request.user.groups.filter(name__in=['Corporation', ]).exists():
            ulb_total_project = MasterSanctionForm.objects.filter(
                AgencyName__AgencyName=request.user.first_name).filter(Date_AS__range=["2022-04-01", "2023-03-31"]).count()
            ulb_project_cost = MasterSanctionForm.objects.filter(
                AgencyName__AgencyName=request.user.first_name).filter(Date_AS__range=["2022-04-01", "2023-03-31"]).aggregate(
                project_cost=Sum('ApprovedProjectCost'))
        else:
            ulb_total_project = MasterSanctionForm.objects.filter(
                AgencyName__AgencyName=request.user.first_name).filter(
                AgencyType__AgencyType=ULBType[1]).filter(Date_AS__range=["2022-04-01", "2023-03-31"]).count()
            ulb_project_cost = MasterSanctionForm.objects.filter(AgencyName__AgencyName=request.user.first_name).filter(
                AgencyType__AgencyType=ULBType[1]).filter(Date_AS__range=["2022-04-01", "2023-03-31"]).aggregate(
                project_cost=Sum('ApprovedProjectCost'))

        ulb_knmt_share = MasterSanctionForm.objects.filter(AgencyName__AgencyName=request.user.first_name).filter(
            AgencyType__AgencyType=ULBType[1]).filter(
            Scheme__Scheme='KNMT').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).aggregate(knmt_share=Sum('SchemeShare'))

        ulb_share_ulb = MasterSanctionForm.objects.filter(AgencyName__AgencyName=request.user.first_name).filter(
            Scheme__Scheme='KNMT').filter(AgencyType__AgencyType=ULBType[1]).filter(Date_AS__range=["2022-04-01", "2023-03-31"]).aggregate(ulb_share=Sum('ULBShare'))
        ulb_singara_share = MasterSanctionForm.objects.filter(AgencyName__AgencyName=request.user.first_name).filter(
            Scheme__Scheme='Singara Chennai 2.0').filter(Date_AS__range=["2022-04-01", "2023-03-31"]).aggregate(singara_share=Sum('SchemeShare'))
        ulb_share_ulb_singara = MasterSanctionForm.objects.filter(
            AgencyName__AgencyName=request.user.first_name).filter(
...
@admin.register(KNMTDashboardR2122)
class DashboardAdmin(admin.ModelAdmin):
    change_list_template = "admin/dashboard.html"
    ...
    def changelist_view(self, request, extra_context=None):
        ...
        total_projects = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).count()
        project_cost = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).aggregate(project_cost=Sum('ApprovedProjectCost'))
        dmp_project_cost = MasterSanctionForm.objects.filter(AgencyType__AgencyType='Municipality').filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).aggregate(dmp_project_cost=Sum('ApprovedProjectCost'))
        ctp_project_cost = MasterSanctionForm.objects.filter(AgencyType__AgencyType='Town Panchayat').filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).aggregate(ctp_project_cost=Sum('ApprovedProjectCost'))

        sector_list = list(MasterSanctionForm.objects.values_list('Sector', flat=True).all().distinct().filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).exclude(Sector__in=['BT Road', 'CC Road', 'Retaining wall', 'Paver Block', 'SWD', 'Culvert',
                        'Metal Beam Crash Barriers']))
        swps_final_list = []
        
        for sector in sector_list:
            sector_total = MasterSanctionForm.objects.filter(Sector=sector).filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(Scheme__Scheme='KNMT').count()
            sector_cost = MasterSanctionForm.objects.filter(Sector=sector).filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(Scheme__Scheme='KNMT').aggregate(project_cost=Sum('ApprovedProjectCost'))
            try:
                sector_percentage = "{:.2f}".format((sector_cost['project_cost']) / (project_cost['project_cost']) * 100)
            except TypeError:
                sector_percentage = 0.0
            DMA_total = MasterSanctionForm.objects.filter(Sector=sector).filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(AgencyType__AgencyType="Municipality").count()
            DMA_cost = MasterSanctionForm.objects.filter(Sector=sector).filter(Scheme__Scheme='KNMT').filter(AgencyType__AgencyType="Municipality").filter(Date_AS__range=["2021-04-01", "2022-03-31"]).aggregate(project_cost=Sum('ApprovedProjectCost'))
            try:
                DMA_percentage = "{:.2f}".format((DMA_cost['project_cost']) / (dmp_project_cost['dmp_project_cost']) * 100)
            except TypeError:
                DMA_percentage = 0.0
            CTP_total = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Sector=sector).filter(AgencyType__AgencyType="Town Panchayat").filter(Date_AS__range=["2021-04-01", "2022-03-31"]).count()
            CTP_cost = MasterSanctionForm.objects.filter(Sector=sector).filter(Scheme__Scheme='KNMT').filter(AgencyType__AgencyType="Town Panchayat").filter(Date_AS__range=["2021-04-01", "2022-03-31"]).aggregate(project_cost=Sum('ApprovedProjectCost'))
            try:
                CTP_percentage = "{:.2f}".format((CTP_cost['project_cost']) / (ctp_project_cost['ctp_project_cost']) * 100)
            except TypeError:
                CTP_percentage = 0.0
        ...
        road = MasterSanctionForm.objects.filter(Sector__in=['BT Road', 'CC Road', 'Retaining wall', 'Paver Block', 'SWD', 'Culvert','Metal Beam Crash Barriers']).filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).aggregate(project_cost=Sum('ApprovedProjectCost'))
        road_total = MasterSanctionForm.objects.filter(Sector__in=['BT Road', 'CC Road', 'Retaining wall', 'Paver Block', 'SWD', 'Culvert','Metal Beam Crash Barriers']).filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).count()
        road_pt = "{:.2f}".format((road['project_cost']) / (project_cost['project_cost']) * 100)
        roadDMA = MasterSanctionForm.objects.filter(Sector__in=['BT Road', 'CC Road', 'Retaining wall', 'Paver Block', 'SWD', 'Culvert','Metal Beam Crash Barriers']).filter(Scheme__Scheme='KNMT').filter(AgencyType__AgencyType="Municipality").filter(Date_AS__range=["2021-04-01", "2022-03-31"]).aggregate(project_cost=Sum('ApprovedProjectCost'))
        roadDMA_total = MasterSanctionForm.objects.filter(Sector__in=['BT Road', 'CC Road', 'Retaining wall', 'Paver Block', 'SWD', 'Culvert','Metal Beam Crash Barriers']).filter(AgencyType__AgencyType="Municipality").filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).count()
        DMAroad_percentage = "{:.2f}".format((roadDMA['project_cost']) / (dmp_project_cost['dmp_project_cost']) * 100)
        roadCTP = MasterSanctionForm.objects.filter(Sector__in=['BT Road', 'CC Road', 'Retaining wall', 'Paver Block', 'SWD', 'Culvert', 'Metal Beam Crash Barriers']).filter(AgencyType__AgencyType="Town Panchayat").filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).aggregate(project_cost=Sum('ApprovedProjectCost'))
        if roadCTP['project_cost'] == None:
            roadCTP['project_cost'] = 0
        roadCTP_total = MasterSanctionForm.objects.filter(Sector__in=['BT Road', 'CC Road', 'Retaining wall', 'Paver Block', 'SWD', 'Culvert', 'Metal Beam Crash Barriers']).filter(AgencyType__AgencyType="Town Panchayat").filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).count()
        CTProad_percentage = "{:.2f}".format((roadCTP['project_cost']) / (ctp_project_cost['ctp_project_cost']) * 100)
        dic2 = {
            "sector_total":road_total,
            "sector_cost":road,
        ...
        sector_progress = []
        sector_progress_list = list(MasterSanctionForm.objects.values_list('Sector', flat=True).order_by('Sector').all().distinct().filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]))
        ...
        for sector in sector_progress_list:
            approved_project_count = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Sector=sector).filter(Date_AS__range=["2021-04-01", "2022-03-31"]).count()
            approved_project_cost = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Sector=sector).filter(Date_AS__range=["2021-04-01", "2022-03-31"]).aggregate(project_cost=Sum('ApprovedProjectCost'))
            completed_count = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(Sector=sector).filter(status='Completed').count()
            completed_approved_project_cost = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(Sector=sector).filter(status='Completed').aggregate(project_cost=Sum('ApprovedProjectCost'))
            inprogress_count = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(Sector=sector).filter(status='In Progress').count()
            inprogress_approved_project_cost = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(Sector=sector).filter(status='In Progress').aggregate(project_cost=Sum('ApprovedProjectCost'))
            tobecommenced_count = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Sector=sector).filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(~Q(Project_ID__in=final_list)).count()
            tobecommenced_project_cost = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Sector=sector).filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(~Q(Project_ID__in=final_list)).aggregate(project_cost=Sum('ApprovedProjectCost'))
            awarded_cost = AgencySanctionModel.objects.filter(Scheme='KNMT').filter(Sector=sector).aggregate(project_cost=Sum('work_awarded_amount1'))
            modal_data = list(MasterSanctionForm.objects.values('AgencyName__AgencyName', 'Project_ID').order_by('AgencyName__AgencyName').filter(Scheme__Scheme='KNMT').filter(Sector=sector).filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(~Q(Project_ID__in=final_list)))
            in_progress = list(AgencyProgressModel.objects.values('ULBName', 'Project_ID', 'percentageofworkdone').order_by('ULBName').filter(Scheme='KNMT').filter(Sector=sector).filter(status='In Progress').annotate(percent=Avg('percentageofworkdone')))
        ...
        DMAsector_progress = []
        DMAsector_progress_list = list(MasterSanctionForm.objects.values_list('Sector', flat=True).order_by('Sector').all().distinct().filter(Scheme__Scheme='KNMT').filter(AgencyType__AgencyType="Municipality").filter(Date_AS__range=["2021-04-01", "2022-03-31"]))
        
        for sector in DMAsector_progress_list:
            approved_project_count = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(AgencyType__AgencyType="Municipality").filter(Sector=sector).filter(Date_AS__range=["2021-04-01", "2022-03-31"]).count()
            approved_project_cost = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(AgencyType__AgencyType="Municipality").filter(Sector=sector).filter(Date_AS__range=["2021-04-01", "2022-03-31"]).aggregate(project_cost=Sum('ApprovedProjectCost'))
            completed_count = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(Sector=sector).filter(ULBType="Municipality").filter(status='Completed').count()
            completed_approved_project_cost = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(ULBType="Municipality").filter(Sector=sector).filter(status='Completed').aggregate(project_cost=Sum('ApprovedProjectCost'))
            inprogress_count = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(ULBType="Municipality").filter(Sector=sector).filter(status='In Progress').count()
            inprogress_approved_project_cost = AgencyProgressModel.objects.filter(ULBType="Municipality").filter(Scheme='KNMT').filter(Sector=sector).filter(status='In Progress').aggregate(project_cost=Sum('ApprovedProjectCost'))
            tobecommenced_count = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(AgencyType__AgencyType="Municipality").filter(Sector=sector).filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(~Q(Project_ID__in=final_list)).count()
            tobecommenced_project_cost = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(AgencyType__AgencyType="Municipality").filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(Sector=sector).filter(~Q(Project_ID__in=final_list)).aggregate(project_cost=Sum('ApprovedProjectCost'))
            awarded_cost = AgencySanctionModel.objects.filter(Scheme='KNMT').filter(Sector=sector).filter(ULBType="Municipality").aggregate(project_cost=Sum('work_awarded_amount1'))
            modal_data = list(MasterSanctionForm.objects.values('AgencyName__AgencyName', 'Project_ID').order_by('AgencyName__AgencyName').filter(AgencyType__AgencyType="Municipality").filter(Scheme__Scheme='KNMT').filter(Sector=sector).filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(~Q(Project_ID__in=final_list)))
            in_progress = list(AgencyProgressModel.objects.values('ULBName', 'Project_ID', 'percentageofworkdone').order_by('ULBName').filter(ULBType="Municipality").filter(Scheme='KNMT').filter(Sector=sector).filter(status='In Progress').annotate(percent=Avg('percentageofworkdone')))
        ...
        CTPsector_progress = []
        CTPsector_progress_list = list(MasterSanctionForm.objects.values_list('Sector', flat=True).order_by('Sector').all().distinct().filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(AgencyType__AgencyType="Town Panchayat"))
        
        for sector in CTPsector_progress_list:
            approved_project_count = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(AgencyType__AgencyType="Town Panchayat").filter(Sector=sector).filter(Date_AS__range=["2021-04-01", "2022-03-31"]).count()
            approved_project_cost = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(AgencyType__AgencyType="Town Panchayat").filter(Sector=sector).filter(Date_AS__range=["2021-04-01", "2022-03-31"]).aggregate(project_cost=Sum('ApprovedProjectCost'))
            completed_count = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(Sector=sector).filter(ULBType="Town Panchayat").filter(status='Completed').count()
            completed_approved_project_cost = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(ULBType="Town Panchayat").filter(Sector=sector).filter(status='Completed').aggregate(project_cost=Sum('ApprovedProjectCost'))
            inprogress_count = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(ULBType="Town Panchayat").filter(Sector=sector).filter(status='In Progress').count()
            inprogress_approved_project_cost = AgencyProgressModel.objects.filter(ULBType="Town Panchayat").filter(Scheme='KNMT').filter(Sector=sector).filter(status='In Progress').aggregate(project_cost=Sum('ApprovedProjectCost'))
            tobecommenced_count = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(AgencyType__AgencyType="Town Panchayat").filter(Sector=sector).filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(~Q(Project_ID__in=final_list)).count()
            tobecommenced_project_cost = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(AgencyType__AgencyType="Town Panchayat").filter(Sector=sector).filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(~Q(Project_ID__in=final_list)).aggregate(project_cost=Sum('ApprovedProjectCost'))
            awarded_cost = AgencySanctionModel.objects.filter(Scheme='KNMT').filter(Sector=sector).filter(ULBType="Town Panchayat").aggregate(project_cost=Sum('work_awarded_amount1'))
            modal_data = list(MasterSanctionForm.objects.values('AgencyName__AgencyName', 'Project_ID').order_by('AgencyName__AgencyName').filter(AgencyType__AgencyType="Town Panchayat").filter(Scheme__Scheme='KNMT').filter(Sector=sector).filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(~Q(Project_ID__in=final_list)))
            in_progress = list(AgencyProgressModel.objects.values('ULBName', 'Project_ID', 'percentageofworkdone').order_by('ULBName').filter(ULBType="Town Panchayat").filter(Scheme='KNMT').filter(Sector=sector).filter(status='In Progress').annotate(percent=Avg('percentageofworkdone')))
        ...
        district_map = []
        for district in district_list:
            District_project_cost = MasterSanctionForm.objects.filter(District__District=district).filter(Date_AS__range=["2021-04-01", "2022-03-31"]).aggregate(project_cost=Sum('ApprovedProjectCost'))
            District_total_projects = MasterSanctionForm.objects.filter(District__District=district).filter(Date_AS__range=["2021-04-01", "2022-03-31"]).count()
            DMA_project_cost = MasterSanctionForm.objects.filter(District__District=district).filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(AgencyType__AgencyType='Municipality').aggregate(project_cost=Sum('ApprovedProjectCost'))
            DMA_total_projects = MasterSanctionForm.objects.filter(District__District=district).filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(AgencyType__AgencyType='Municipality').count()
            CTP_project_cost = MasterSanctionForm.objects.filter(District__District=district).filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(AgencyType__AgencyType='Town Panchayat').aggregate(project_cost=Sum('ApprovedProjectCost'))
            CTP_total_projects = MasterSanctionForm.objects.filter(District__District=district).filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(AgencyType__AgencyType='Town Panchayat').count()
            Latitude = list(District.objects.values_list('Latitude', flat=True).filter(District=district))[0]
            Longitude = list(District.objects.values_list('Longitude', flat=True).filter(District=district))[0]
        ...
        total_awarded_cost = AgencySanctionModel.objects.filter(Scheme='KNMT').aggregate(
            project_cost=Sum('work_awarded_amount1'))
        total_ap_project_count = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).count()
        total_approved_project_cost = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).aggregate(
            project_cost=Sum('ApprovedProjectCost'))
        total_completed_count = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(
            status='Completed').count()
        total_completed_approved_project_cost = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(
        ...
        total_inprogress_approved_project_cost = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(
            status='In Progress').aggregate(project_cost=Sum('ApprovedProjectCost'))
        total_tobecommenced_count = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(
            ~Q(Project_ID__in=final_list)).count()
        total_tobecommenced_project_cost = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(
            ~Q(Project_ID__in=final_list)).aggregate(project_cost=Sum('ApprovedProjectCost'))

        DMAtotal_awarded_cost = AgencySanctionModel.objects.filter(Scheme='KNMT').filter(
            ULBType='Municipality').aggregate(
            project_cost=Sum('work_awarded_amount1'))
        DMAtotal_approved_project_count = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(
            AgencyType__AgencyType='Municipality').count()
        DMAtotal_approved_project_cost = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(
            AgencyType__AgencyType='Municipality').aggregate(
            project_cost=Sum('ApprovedProjectCost'))
        DMAtotal_completed_count = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(
            ULBType='Municipality').filter(
        ...
        DMAtotal_inprogress_approved_project_cost = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(
            ULBType='Municipality').filter(
            status='In Progress').aggregate(project_cost=Sum('ApprovedProjectCost'))
        DMAtotal_tobecommenced_count = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(
            AgencyType__AgencyType='Municipality').filter(
            ~Q(Project_ID__in=final_list)).count()
        DMAtotal_tobecommenced_project_cost = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(
            AgencyType__AgencyType='Municipality').filter(
            ~Q(Project_ID__in=final_list)).aggregate(project_cost=Sum('ApprovedProjectCost'))
        ...
        CTPtotal_awarded_cost = AgencySanctionModel.objects.filter(Scheme='KNMT').filter(
            ULBType='Town Panchayat').aggregate(
            project_cost=Sum('work_awarded_amount1'))
        CTPtotal_approved_project_count = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(
            AgencyType__AgencyType='Town Panchayat').count()
        CTPtotal_approved_project_cost = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(
            AgencyType__AgencyType='Town Panchayat').aggregate(
            project_cost=Sum('ApprovedProjectCost'))
        CTPtotal_completed_count = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(
            ULBType='Town Panchayat').filter(
        ...
        CTPtotal_inprogress_approved_project_cost = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(
            ULBType='Town Panchayat').filter(
            status='In Progress').aggregate(project_cost=Sum('ApprovedProjectCost'))
        CTPtotal_tobecommenced_count = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(
            AgencyType__AgencyType='Town Panchayat').filter(
            ~Q(Project_ID__in=final_list)).count()
        CTPtotal_tobecommenced_project_cost = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(
            AgencyType__AgencyType='Town Panchayat').filter(
            ~Q(Project_ID__in=final_list)).aggregate(project_cost=Sum('ApprovedProjectCost'))        

        busstand = MasterSanctionForm.objects.filter(Sector__in=['Bus Stand']).filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).aggregate(
            project_cost=Sum('ApprovedProjectCost'))
        busstand_total = MasterSanctionForm.objects.filter(Sector__in=['Bus Stand']).filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(
            Scheme__Scheme='KNMT').count()
        busstandDMA = MasterSanctionForm.objects.filter(Sector__in=['Bus Stand']).filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(
            AgencyType__AgencyType="Municipality").aggregate(project_cost=Sum('ApprovedProjectCost'))
        busstandDMA_total = MasterSanctionForm.objects.filter(Sector__in=['Bus Stand']).filter(
            Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(
            AgencyType__AgencyType="Municipality").count()
        busstandCTP = MasterSanctionForm.objects.filter(Sector__in=['Bus Stand']).filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(
            AgencyType__AgencyType="Town Panchayat").aggregate(project_cost=Sum('ApprovedProjectCost'))
        busstandCTP_total = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(
            Sector__in=['Bus Stand']).filter(
            AgencyType__AgencyType="Town Panchayat").count()

        ch = MasterSanctionForm.objects.filter(Sector__in=['Community Hall']).filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).aggregate(
            project_cost=Sum('ApprovedProjectCost'))
        ch_total = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(
            Sector__in=['Community Hall']).count()
        chDMA = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(Sector__in=['Community Hall']).filter(
            AgencyType__AgencyType="Municipality").aggregate(project_cost=Sum('ApprovedProjectCost'))
        chDMA_total = MasterSanctionForm.objects.filter(Sector__in=['Community Hall']).filter(
            Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(
            AgencyType__AgencyType="Municipality").count()
        chCTP = MasterSanctionForm.objects.filter(Sector="Community Hall").filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(
            AgencyType__AgencyType="Town Panchayat").aggregate(project_cost=Sum('ApprovedProjectCost'))
        chCTP_total = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(
            Sector__in=['Community Hall']).filter(
            AgencyType__AgencyType="Town Panchayat").count()

        crematorium = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(
            Sector__in=['Crematorium']).aggregate(
            project_cost=Sum('ApprovedProjectCost'))
        crematorium_total = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(
            Sector__in=['Crematorium']).count()
        crematoriumDMA = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(
            Sector__in=['Crematorium']).filter(
            AgencyType__AgencyType="Municipality").filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).aggregate(
            project_cost=Sum('ApprovedProjectCost'))
        crematoriumDMA_total = MasterSanctionForm.objects.filter(Sector__in=['Crematorium']).filter(
            Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(
            AgencyType__AgencyType="Municipality").count()
        crematoriumCTP = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(
            Sector__in=['Crematorium']).filter(
            AgencyType__AgencyType="Town Panchayat").aggregate(project_cost=Sum('ApprovedProjectCost'))
        crematoriumCTP_total = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(
            Sector__in=['Crematorium']).filter(
            AgencyType__AgencyType="Town Panchayat").count()

        KC = MasterSanctionForm.objects.filter(Sector__in=['Knowledge Centre']).filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).aggregate(
            project_cost=Sum('ApprovedProjectCost'))
        KC_total = MasterSanctionForm.objects.filter(Sector__in=['Knowledge Centre']).filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(
            Scheme__Scheme='KNMT').count()
        KCDMA = MasterSanctionForm.objects.filter(Sector__in=['Knowledge Centre']).filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(
            AgencyType__AgencyType="Municipality").aggregate(project_cost=Sum('ApprovedProjectCost'))
        KCDMA_total = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(
            Sector__in=['Knowledge Centre']).filter(
            AgencyType__AgencyType="Municipality").count()
        KCCTP = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(Sector__in=['Knowledge Centre']).filter(
            AgencyType__AgencyType="Town Panchayat").aggregate(project_cost=Sum('ApprovedProjectCost'))
        KCCTP_total = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(
            Sector__in=['Knowledge Centre']).filter(
            AgencyType__AgencyType="Town Panchayat").count()

        market = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(Sector__in=['Market']).aggregate(
            project_cost=Sum('ApprovedProjectCost'))
        market_total = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(Sector__in=['Market']).count()
        marketDMA = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(Sector__in=['Market']).filter(
            AgencyType__AgencyType="Municipality").aggregate(project_cost=Sum('ApprovedProjectCost'))
        marketDMA_total = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(Sector__in=['Market']).filter(
            AgencyType__AgencyType="Municipality").count()
        marketCTP = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(Sector__in=['Market']).filter(
            AgencyType__AgencyType="Town Panchayat").aggregate(project_cost=Sum('ApprovedProjectCost'))
        marketCTP_total = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(Sector__in=['Market']).filter(
            AgencyType__AgencyType="Town Panchayat").count()
        
        park = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Sector__in=['Parks']).filter(Date_AS__range=["2021-04-01", "2022-03-31"]).aggregate(
            project_cost=Sum('ApprovedProjectCost'))
        park_total = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Sector__in=['Parks']).filter(Date_AS__range=["2021-04-01", "2022-03-31"]).count()
        parkDMA = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Sector__in=['Parks']).filter(
            AgencyType__AgencyType="Municipality").filter(Date_AS__range=["2021-04-01", "2022-03-31"]).aggregate(project_cost=Sum('ApprovedProjectCost'))
        parkDMA_total = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Sector__in=['Parks']).filter(
            AgencyType__AgencyType="Municipality").filter(Date_AS__range=["2021-04-01", "2022-03-31"]).count()
        parkCTP = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Sector__in=['Parks']).filter(
            AgencyType__AgencyType="Town Panchayat").filter(Date_AS__range=["2021-04-01", "2022-03-31"]).aggregate(project_cost=Sum('ApprovedProjectCost'))
        
        if parkCTP['project_cost'] == None:
            parkCTP['project_cost'] = 0
        
        parkCTP_total = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Sector__in=['Parks']).filter(
            AgencyType__AgencyType="Town Panchayat").filter(Date_AS__range=["2021-04-01", "2022-03-31"]).count()

        SWM = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(
            Sector__in=['Solid Waste Mgt.']).aggregate(
            project_cost=Sum('ApprovedProjectCost'))
        SWM_total = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(
            Sector__in=['Solid Waste Mgt.']).count()
        SWMDMA = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(
            Sector__in=['Solid Waste Mgt.']).filter(
            AgencyType__AgencyType="Municipality").aggregate(project_cost=Sum('ApprovedProjectCost'))
        SWMDMA_total = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(
            Sector__in=['Solid Waste Mgt.']).filter(
            AgencyType__AgencyType="Municipality").count()
        SWMCTP = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(
            Sector__in=['Solid Waste Mgt.']).filter(
            AgencyType__AgencyType="Town Panchayat").aggregate(project_cost=Sum('ApprovedProjectCost'))
        SWMCTP_total = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(
            Sector__in=['Solid Waste Mgt.']).filter(
            AgencyType__AgencyType="Town Panchayat").count()

        RW = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(Sector__in=['Retaining wall']).aggregate(
            project_cost=Sum('ApprovedProjectCost'))
        RW_total = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(
            Sector__in=['Retaining wall']).count()
        RWDMA = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Sector__in=['Retaining wall']).filter(
            AgencyType__AgencyType="Municipality").filter(Date_AS__range=["2021-04-01", "2022-03-31"]).aggregate(project_cost=Sum('ApprovedProjectCost'))
        RWDMA_total = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(
            Sector__in=['Retaining wall']).filter(AgencyType__AgencyType="Municipality").filter(Date_AS__range=["2021-04-01", "2022-03-31"]).count()
        RWCTP = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Sector="Retaining wall").filter(
            AgencyType__AgencyType="Town Panchayat").filter(Date_AS__range=["2021-04-01", "2022-03-31"]).aggregate(project_cost=Sum('ApprovedProjectCost'))
        RWCTP_total = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(
            Sector__in=['Retaining wall']).filter(
        ...
        WB = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Sector__in=['Water Bodies']).filter(Date_AS__range=["2021-04-01", "2022-03-31"]).aggregate(
            project_cost=Sum('ApprovedProjectCost'))
        WB_total = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Sector__in=['Water Bodies']).filter(Date_AS__range=["2021-04-01", "2022-03-31"]).count()
        WBDMA = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Sector__in=['Water Bodies']).filter(Date_AS__range=["2021-04-01", "2022-03-31"]).filter(
            AgencyType__AgencyType="Municipality").filter(Date_AS__range=["2021-04-01", "2022-03-31"]).aggregate(project_cost=Sum('ApprovedProjectCost'))
        WBDMA_total = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(
            Sector__in=['Water Bodies']).filter(AgencyType__AgencyType="Municipality").filter(Date_AS__range=["2021-04-01", "2022-03-31"]).count()
        WBCTP = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Sector="Water Bodies").filter(
            AgencyType__AgencyType="Town Panchayat").filter(Date_AS__range=["2021-04-01", "2022-03-31"]).aggregate(project_cost=Sum('ApprovedProjectCost'))
        WBCTP_total = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(
            Sector__in=['Water Bodies']).filter(AgencyType__AgencyType="Town Panchayat").filter(Date_AS__range=["2021-04-01", "2022-03-31"]).count()
        ...
        knmt = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).aggregate(knmt_share=Sum('SchemeShare'))
        ulb_share = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).aggregate(ulb_share=Sum('ULBShare'))
        dmp_total_projects = MasterSanctionForm.objects.filter(AgencyType__AgencyType='Municipality').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).count()
        dmp_knmt = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(
            AgencyType__AgencyType='Municipality').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).aggregate(dmp_knmt=Sum('SchemeShare'))
        dmp_ulb_share = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(
            AgencyType__AgencyType='Municipality').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).aggregate(dmp_ulb_share=Sum('ULBShare'))
        ctp_total_projects = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(
            AgencyType__AgencyType='Town Panchayat').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).count()
        ctp_project_cost = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(
            AgencyType__AgencyType='Town Panchayat').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).aggregate(ctp_project_cost=Sum('ApprovedProjectCost'))
        ctp_knmt = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(
            AgencyType__AgencyType='Town Panchayat').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).aggregate(ctp_knmt=Sum('SchemeShare'))
        ctp_ulb_share = MasterSanctionForm.objects.filter(Scheme__Scheme='KNMT').filter(
            AgencyType__AgencyType='Town Panchayat').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).aggregate(ctp_ulb_share=Sum('ULBShare'))
        if request.user.groups.filter(name__in=['Corporation', ]).exists():
            ulb_total_project = MasterSanctionForm.objects.filter(
                AgencyName__AgencyName=request.user.first_name).filter(Date_AS__range=["2021-04-01", "2022-03-31"]).count()
            ulb_project_cost = MasterSanctionForm.objects.filter(
                AgencyName__AgencyName=request.user.first_name).filter(Date_AS__range=["2021-04-01", "2022-03-31"]).aggregate(
                project_cost=Sum('ApprovedProjectCost'))
        else:
            ulb_total_project = MasterSanctionForm.objects.filter(
                AgencyName__AgencyName=request.user.first_name).filter(
                AgencyType__AgencyType=ULBType[1]).filter(Date_AS__range=["2021-04-01", "2022-03-31"]).count()
            ulb_project_cost = MasterSanctionForm.objects.filter(AgencyName__AgencyName=request.user.first_name).filter(
                AgencyType__AgencyType=ULBType[1]).filter(Date_AS__range=["2021-04-01", "2022-03-31"]).aggregate(
                project_cost=Sum('ApprovedProjectCost'))

        ulb_knmt_share = MasterSanctionForm.objects.filter(AgencyName__AgencyName=request.user.first_name).filter(
            AgencyType__AgencyType=ULBType[1]).filter(
            Scheme__Scheme='KNMT').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).aggregate(knmt_share=Sum('SchemeShare'))

        ulb_share_ulb = MasterSanctionForm.objects.filter(AgencyName__AgencyName=request.user.first_name).filter(
            Scheme__Scheme='KNMT').filter(AgencyType__AgencyType=ULBType[1]).filter(Date_AS__range=["2021-04-01", "2022-03-31"]).aggregate(ulb_share=Sum('ULBShare'))
        ulb_singara_share = MasterSanctionForm.objects.filter(AgencyName__AgencyName=request.user.first_name).filter(
            Scheme__Scheme='Singara Chennai 2.0').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).aggregate(singara_share=Sum('SchemeShare'))
        ulb_share_ulb_singara = MasterSanctionForm.objects.filter(
            AgencyName__AgencyName=request.user.first_name).filter(
            Scheme__Scheme='Singara Chennai 2.0').filter(Date_AS__range=["2021-04-01", "2022-03-31"]).aggregate(ulb_share=Sum('ULBShare'))
