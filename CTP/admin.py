...
class MasterReportAdmin(admin.ModelAdmin):
    ...
    def changelist_view(self, request, extra_context=None):
        ...
        BT_Road_value_work_done_completed  = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(ULBType='Town Panchayat').filter(Sector='BT Road').filter(status='Completed').aggregate(sum=Sum('valueofworkdone'))
        BT_Road_value_work_done_inprogress  = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(ULBType='Town Panchayat').filter(Sector='BT Road').filter(status='In Progress').aggregate(sum=Sum('valueofworkdone'))
        BT_Road_final = list(AgencyProgressModel.objects.values_list('Project_ID', flat=True).filter(ULBType='Town Panchayat').filter(Scheme='KNMT').filter(Sector='BT Road').filter(
            status='Not Commenced'))
        BT_Road_TS_Awarded = AgencySanctionModel.objects.filter(Scheme='KNMT').filter(Sector='BT Road').filter(ULBType='Town Panchayat').filter(ts_awarded='Yes').filter(Q(Project_ID__in=BT_Road_final)).count()
        BT_Road_WO_Awarded = AgencySanctionModel.objects.filter(Scheme='KNMT').filter(Sector='BT Road').filter(ULBType='Town Panchayat').filter(wd_awarded='Yes').filter(Q(Project_ID__in=BT_Road_final)).count()
        ...
        Bus_Stand_value_work_done_completed  = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(ULBType='Town Panchayat').filter(Sector='Bus Stand').filter(status='Completed').aggregate(sum=Sum('valueofworkdone'))
        Bus_Stand_value_work_done_inprogress  = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(ULBType='Town Panchayat').filter(Sector='Bus Stand').filter(status='In Progress').aggregate(sum=Sum('valueofworkdone'))
        Bus_Stand_final = list(AgencyProgressModel.objects.values_list('Project_ID', flat=True).filter(ULBType='Town Panchayat').filter(Scheme='KNMT').filter(Sector='Bus Stand').filter(
            status='Not Commenced'))
        Bus_Stand_TS_Awarded = AgencySanctionModel.objects.filter(Scheme='KNMT').filter(ULBType='Town Panchayat').filter(Sector='Bus Stand').filter(ts_awarded='Yes').filter(Q(Project_ID__in=Bus_Stand_final)).count()
        Bus_Stand_WO_Awarded = AgencySanctionModel.objects.filter(Scheme='KNMT').filter(ULBType='Town Panchayat').filter(Sector='Bus Stand').filter(wd_awarded='Yes').filter(Q(Project_ID__in=Bus_Stand_final)).count()
        ...
        CC_Road_value_work_done_completed  = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(ULBType='Town Panchayat').filter(Sector='CC Road').filter(status='Completed').aggregate(sum=Sum('valueofworkdone'))
        CC_Road_value_work_done_inprogress  = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(ULBType='Town Panchayat').filter(Sector='CC Road').filter(status='In Progress').aggregate(sum=Sum('valueofworkdone'))
        CC_Road_final = list(AgencyProgressModel.objects.values_list('Project_ID', flat=True).filter(ULBType='Town Panchayat').filter(Scheme='KNMT').filter(Sector='CC Road').filter(
            status='Not Commenced'))
        CC_Road_TS_Awarded = AgencySanctionModel.objects.filter(Scheme='KNMT').filter(ULBType='Town Panchayat').filter(Sector='CC Road').filter(ts_awarded='Yes').filter(Q(Project_ID__in=CC_Road_final)).count()
        CC_Road_WO_Awarded = AgencySanctionModel.objects.filter(Scheme='KNMT').filter(ULBType='Town Panchayat').filter(Sector='CC Road').filter(wd_awarded='Yes').filter(Q(Project_ID__in=CC_Road_final)).count()
        # Community Hall
        ...
        Community_Hall_value_work_done_completed  = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(ULBType='Town Panchayat').filter(Sector='Community Hall').filter(status='Completed').aggregate(sum=Sum('valueofworkdone'))
        Community_Hall_value_work_done_inprogress  = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(ULBType='Town Panchayat').filter(Sector='Community Hall').filter(status='In Progress').aggregate(sum=Sum('valueofworkdone'))
        Community_Hall_final = list(AgencyProgressModel.objects.values_list('Project_ID', flat=True).filter(ULBType='Town Panchayat').filter(Scheme='KNMT').filter(Sector='Community Hall').filter(
            status='Not Commenced'))
        Community_Hall_TS_Awarded = AgencySanctionModel.objects.filter(Scheme='KNMT').filter(ULBType='Town Panchayat').filter(Sector='Community Hall').filter(ts_awarded='Yes').filter(Q(Project_ID__in=Community_Hall_final)).count()
        Community_Hall_WO_Awarded = AgencySanctionModel.objects.filter(Scheme='KNMT').filter(ULBType='Town Panchayat').filter(Sector='Community Hall').filter(wd_awarded='Yes').filter(Q(Project_ID__in=Community_Hall_final)).count()
        # Crematorium
        ...
        Crematorium_value_work_done_completed  = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(ULBType='Town Panchayat').filter(Sector='Crematorium').filter(status='Completed').aggregate(sum=Sum('valueofworkdone'))
        Crematorium_value_work_done_inprogress  = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(ULBType='Town Panchayat').filter(Sector='Crematorium').filter(status='In Progress').aggregate(sum=Sum('valueofworkdone'))
        Crematorium_final = list(AgencyProgressModel.objects.values_list('Project_ID', flat=True).filter(ULBType='Town Panchayat').filter(Scheme='KNMT').filter(Sector='Crematorium').filter(
            status='Not Commenced'))
        Crematorium_TS_Awarded = AgencySanctionModel.objects.filter(Scheme='KNMT').filter(ULBType='Town Panchayat').filter(Sector='Crematorium').filter(ts_awarded='Yes').filter(Q(Project_ID__in=Crematorium_final)).count()
        Crematorium_WO_Awarded = AgencySanctionModel.objects.filter(Scheme='KNMT').filter(ULBType='Town Panchayat').filter(Sector='Crematorium').filter(wd_awarded='Yes').filter(Q(Project_ID__in=Crematorium_final)).count()
        #	Culvert
        ...
        Culvert_value_work_done_completed  = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(ULBType='Town Panchayat').filter(Sector='Culvert').filter(status='Completed').aggregate(sum=Sum('valueofworkdone'))
        Culvert_value_work_done_inprogress  = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(ULBType='Town Panchayat').filter(Sector='Culvert').filter(status='In Progress').aggregate(sum=Sum('valueofworkdone'))
        Culvert_final = list(AgencyProgressModel.objects.values_list('Project_ID', flat=True).filter(ULBType='Town Panchayat').filter(Scheme='KNMT').filter(Sector='Culvert').filter(
            status='Not Commenced'))
        Culvert_TS_Awarded = AgencySanctionModel.objects.filter(Scheme='KNMT').filter(Sector='Culvert').filter(ULBType='Town Panchayat').filter(ts_awarded='Yes').filter(Q(Project_ID__in=Culvert_final)).count()
        Culvert_WO_Awarded = AgencySanctionModel.objects.filter(Scheme='KNMT').filter(Sector='Culvert').filter(ULBType='Town Panchayat').filter(wd_awarded='Yes').filter(Q(Project_ID__in=Culvert_final)).count()
        # Knowledge Centre
        ...
        Knowledge_Centre_value_work_done_completed  = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(ULBType='Town Panchayat').filter(Sector='Knowledge Centre').filter(status='Completed').aggregate(sum=Sum('valueofworkdone'))
        Knowledge_Centre_value_work_done_inprogress  = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(ULBType='Town Panchayat').filter(Sector='Knowledge Centre').filter(status='In Progress').aggregate(sum=Sum('valueofworkdone'))
        Knowledge_Centre_final = list(AgencyProgressModel.objects.values_list('Project_ID', flat=True).filter(Scheme='KNMT').filter(ULBType='Town Panchayat').filter(Sector='Knowledge Centre').filter(
            status='Not Commenced'))
        Knowledge_Centre_TS_Awarded = AgencySanctionModel.objects.filter(Scheme='KNMT').filter(ULBType='Town Panchayat').filter(Sector='Knowledge Centre').filter(ts_awarded='Yes').filter(Q(Project_ID__in=Knowledge_Centre_final)).count()
        Knowledge_Centre_WO_Awarded = AgencySanctionModel.objects.filter(Scheme='KNMT').filter(ULBType='Town Panchayat').filter(Sector='Knowledge Centre').filter(wd_awarded='Yes').filter(Q(Project_ID__in=Knowledge_Centre_final)).count()
        # Market
        ...
        Market_value_work_done_completed  = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(ULBType='Town Panchayat').filter(Sector='Market').filter(status='Completed').aggregate(sum=Sum('valueofworkdone'))
        Market_value_work_done_inprogress  = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(ULBType='Town Panchayat').filter(Sector='Market').filter(status='In Progress').aggregate(sum=Sum('valueofworkdone'))
        Market_final = list(AgencyProgressModel.objects.values_list('Project_ID', flat=True).filter(ULBType='Town Panchayat').filter(Scheme='KNMT').filter(Sector='Market').filter(
            status='Not Commenced'))
        Market_TS_Awarded = AgencySanctionModel.objects.filter(Scheme='KNMT').filter(ULBType='Town Panchayat').filter(Sector='Market').filter(ts_awarded='Yes').filter(Q(Project_ID__in=Market_final)).count()
        Market_WO_Awarded = AgencySanctionModel.objects.filter(Scheme='KNMT').filter(ULBType='Town Panchayat').filter(Sector='Market').filter(wd_awarded='Yes').filter(Q(Project_ID__in=Market_final)).count()
        ...
        M_B_C_B_value_work_done_completed  = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(ULBType='Town Panchayat').filter(Sector='Metal Beam Crash Barriers').filter(status='Completed').aggregate(sum=Sum('valueofworkdone'))
        M_B_C_B_value_work_done_inprogress  = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(ULBType='Town Panchayat').filter(Sector='Metal Beam Crash Barriers').filter(status='In Progress').aggregate(sum=Sum('valueofworkdone'))
        M_B_C_B_final = list(AgencyProgressModel.objects.values_list('Project_ID', flat=True).filter(ULBType='Town Panchayat').filter(Scheme='KNMT').filter(Sector='Metal Beam Crash Barriers').filter(
            status='Not Commenced'))
        M_B_C_B_TS_Awarded = AgencySanctionModel.objects.filter(Scheme='KNMT').filter(ULBType='Town Panchayat').filter(Sector='Metal Beam Crash Barriers').filter(ts_awarded='Yes').filter(Q(Project_ID__in=M_B_C_B_final)).count()
        M_B_C_B_WO_Awarded = AgencySanctionModel.objects.filter(Scheme='KNMT').filter(ULBType='Town Panchayat').filter(Sector='Metal Beam Crash Barriers').filter(wd_awarded='Yes').filter(Q(Project_ID__in=M_B_C_B_final)).count()
        # Parks
        ...
        Parks_value_work_done_completed  = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(ULBType='Town Panchayat').filter(Sector='Parks').filter(status='Completed').aggregate(sum=Sum('valueofworkdone'))
        Parks_value_work_done_inprogress  = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(ULBType='Town Panchayat').filter(Sector='Parks').filter(status='In Progress').aggregate(sum=Sum('valueofworkdone'))
        Parks_final = list(AgencyProgressModel.objects.values_list('Project_ID', flat=True).filter(ULBType='Town Panchayat').filter(Scheme='KNMT').filter(Sector='Parks').filter(
            status='Not Commenced'))
        Parks_TS_Awarded = AgencySanctionModel.objects.filter(Scheme='KNMT').filter(ULBType='Town Panchayat').filter(Sector='Parks').filter(ts_awarded='Yes').filter(Q(Project_ID__in=Parks_final)).count()
        Parks_WO_Awarded = AgencySanctionModel.objects.filter(Scheme='KNMT').filter(ULBType='Town Panchayat').filter(Sector='Parks').filter(wd_awarded='Yes').filter(Q(Project_ID__in=Parks_final)).count()
        ...
        Paver_Block_value_work_done_completed  = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(ULBType='Town Panchayat').filter(Sector='Paver Block').filter(status='Completed').aggregate(sum=Sum('valueofworkdone'))
        Paver_Block_value_work_done_inprogress  = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(ULBType='Town Panchayat').filter(Sector='Paver Block').filter(status='In Progress').aggregate(sum=Sum('valueofworkdone'))
        Paver_Block_final = list(AgencyProgressModel.objects.values_list('Project_ID', flat=True).filter(ULBType='Town Panchayat').filter(Scheme='KNMT').filter(Sector='Paver Block').filter(
            status='Not Commenced'))
        Paver_Block_TS_Awarded = AgencySanctionModel.objects.filter(Scheme='KNMT').filter(ULBType='Town Panchayat').filter(Sector='Paver Block').filter(ts_awarded='Yes').filter(Q(Project_ID__in=Paver_Block_final)).count()
        Paver_Block_WO_Awarded = AgencySanctionModel.objects.filter(Scheme='KNMT').filter(ULBType='Town Panchayat').filter(Sector='Paver Block').filter(wd_awarded='Yes').filter(Q(Project_ID__in=Paver_Block_final)).count()
        ...
        Retaining_wall_value_work_done_completed  = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(ULBType='Town Panchayat').filter(Sector='Retaining wall').filter(status='Completed').aggregate(sum=Sum('valueofworkdone'))
        Retaining_wall_value_work_done_inprogress  = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(ULBType='Town Panchayat').filter(Sector='Retaining wall').filter(status='In Progress').aggregate(sum=Sum('valueofworkdone'))
        Retaining_wall_final = list(AgencyProgressModel.objects.values_list('Project_ID', flat=True).filter(ULBType='Town Panchayat').filter(Scheme='KNMT').filter(Sector='Retaining wall').filter(
            status='Not Commenced'))
        Retaining_wall_TS_Awarded = AgencySanctionModel.objects.filter(Scheme='KNMT').filter(ULBType='Town Panchayat').filter(Sector='Retaining wall').filter(ts_awarded='Yes').filter(Q(Project_ID__in=Retaining_wall_final)).count()
        Retaining_wall_WO_Awarded = AgencySanctionModel.objects.filter(Scheme='KNMT').filter(ULBType='Town Panchayat').filter(Sector='Retaining wall').filter(wd_awarded='Yes').filter(Q(Project_ID__in=Retaining_wall_final)).count()
        ...
        SWM_value_work_done_completed  = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(ULBType='Town Panchayat').filter(Sector='Solid Waste Mgt.').filter(status='Completed').aggregate(sum=Sum('valueofworkdone'))
        SWM_value_work_done_inprogress  = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(ULBType='Town Panchayat').filter(Sector='Solid Waste Mgt.').filter(status='In Progress').aggregate(sum=Sum('valueofworkdone'))
        SWM_final = list(AgencyProgressModel.objects.values_list('Project_ID', flat=True).filter(ULBType='Town Panchayat').filter(Scheme='KNMT').filter(Sector='Solid Waste Mgt.').filter(
            status='Not Commenced'))
        SWM_TS_Awarded = AgencySanctionModel.objects.filter(Scheme='KNMT').filter(ULBType='Town Panchayat').filter(Sector='Solid Waste Mgt.').filter(ts_awarded='Yes').filter(Q(Project_ID__in=SWM_final)).count()
        SWM_WO_Awarded = AgencySanctionModel.objects.filter(Scheme='KNMT').filter(ULBType='Town Panchayat').filter(Sector='Solid Waste Mgt.').filter(wd_awarded='Yes').filter(Q(Project_ID__in=SWM_final)).count()
        # SWD
        ...
        SWD_value_work_done_completed  = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(ULBType='Town Panchayat').filter(Sector='SWD').filter(status='Completed').aggregate(sum=Sum('valueofworkdone'))
        SWD_value_work_done_inprogress  = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(ULBType='Town Panchayat').filter(Sector='SWD').filter(status='In Progress').aggregate(sum=Sum('valueofworkdone'))
        SWD_final = list(AgencyProgressModel.objects.values_list('Project_ID', flat=True).filter(ULBType='Town Panchayat').filter(Scheme='KNMT').filter(Sector='SWD').filter(
            status='Not Commenced'))
        SWD_TS_Awarded = AgencySanctionModel.objects.filter(Scheme='KNMT').filter(Sector='SWD').filter(ULBType='Town Panchayat').filter(ts_awarded='Yes').filter(Q(Project_ID__in=SWD_final)).count()
        SWD_WO_Awarded = AgencySanctionModel.objects.filter(Scheme='KNMT').filter(Sector='SWD').filter(ULBType='Town Panchayat').filter(wd_awarded='Yes').filter(Q(Project_ID__in=SWD_final)).count()
        ...
        Water_Bodies_value_work_done_completed  = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(ULBType='Town Panchayat').filter(Sector='Water Bodies').filter(status='Completed').aggregate(sum=Sum('valueofworkdone'))
        Water_Bodies_value_work_done_inprogress  = AgencyProgressModel.objects.filter(Scheme='KNMT').filter(ULBType='Town Panchayat').filter(Sector='Water Bodies').filter(status='In Progress').aggregate(sum=Sum('valueofworkdone'))
        Water_Bodies_final = list(AgencyProgressModel.objects.values_list('Project_ID', flat=True).filter(ULBType='Town Panchayat').filter(Scheme='KNMT').filter(Sector='Water Bodies').filter(
            status='Not Commenced'))
        Water_Bodies_TS_Awarded = AgencySanctionModel.objects.filter(Scheme='KNMT').filter(ULBType='Town Panchayat').filter(Sector='Water Bodies').filter(ts_awarded='Yes').filter(Q(Project_ID__in=Water_Bodies_final)).count()
        Water_Bodies_WO_Awarded = AgencySanctionModel.objects.filter(Scheme='KNMT').filter(ULBType='Town Panchayat').filter(Sector='Water Bodies').filter(wd_awarded='Yes').filter(Q(Project_ID__in=Water_Bodies_final)).count()
        ...
        Overall_final = list(AgencyProgressModel.objects.values_list('Project_ID', flat=True).filter(ULBType='Town Panchayat').filter(Scheme='KNMT').filter(
            status='Not Commenced'))
        Overall_TS_Awarded = AgencySanctionModel.objects.filter(Scheme='KNMT').filter(ts_awarded='Yes').filter(ULBType='Town Panchayat').filter(Q(Project_ID__in=Overall_final)).count()
        Overall_WO_Awarded = AgencySanctionModel.objects.filter(Scheme='KNMT').filter(wd_awarded='Yes').filter(ULBType='Town Panchayat').filter(Q(Project_ID__in=Overall_final)).count()
        extra_context = {
