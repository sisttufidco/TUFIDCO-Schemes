...
class ReleaseRequestModel(models.Model):
    ...
    release1Amount = models.DecimalField('Release Amount 1', blank=True, decimal_places=2, max_digits=8, null=True)
    release2Date = models.DateField('Release Date 2', blank=True, null=True)
    release2Amount = models.DecimalField('Release Amount 2', blank=True,  decimal_places=2, max_digits=8, null=True)
    ...
    release3Amount = models.DecimalField('Release Amount 3', blank=True, decimal_places=2, max_digits=8, null=True)
    ...
    release4Amount = models.DecimalField('Release Amount 4', blank=True, decimal_places=2, max_digits=8, null=True)
    ...
    release5Amount = models.DecimalField('Release Amount 5', blank=True,  decimal_places=2, max_digits=8, null=True)
